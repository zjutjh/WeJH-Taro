...
export const helpText = {
  ...
  score:
    "GPA为您本学期的平均学分绩点，默认将本学期所有科目纳入计算。各学院纳入绩点计算的课程有所不同， 您可参考学院相关文件说明后，点击计算器按钮自行更改科目重新计算绩点。若计算结果与正方不一致，请以正方为准，微精弘计算结果仅供参考。（未纳入计算的科目一栏在此页呈现灰色）",
  mediaScore:
    "期中成绩仅为方便查询显示，其数据不纳入正式GPA计算，遂此页面无GPA数据和绩点计算器功能。",
  lostfound:
  ...
  suit: {
    ...
    information:
      "感谢您使用由学生事务大厅与精弘网络合作共同开发的“正装借用”，请在使用前正确填写您的真实个人信息，以便后续工作的开展。",
