...
import ElectricityQuickView from "../electricity-quick-view/index.vue";
import ExamQuickView from "../exam-quick-view/index.vue";
import LessonsTableQuickView from "../lessons-table-quick-view/index.vue";
import LibraryQuickView from "../library-quick-view/index.vue";
import SchoolCardQuickView from "../school-card-quick-view/index.vue";
import ScoreQuickView from "../score-quick-view/index.vue";
...
const cardsMap = computed(() => ({
  "lessons-table-quick-view": isBindZf.value
    ? h(LessonsTableQuickView, {
        onShowHelp: () => showHelp("lessons-table")
      })
    : null,
  "exam-quick-view": isBindZf.value
    ? h(ExamQuickView, {
        onShowHelp: () => showHelp("exam-card")
      })
    : null,
  "school-card-quick-view": isBindYxy.value
    ? h(SchoolCardQuickView, {
        onShowHelp: () => showHelp("school-card")
      })
    : null,
  "score-quick-view": isBindZf.value
    ? h(ScoreQuickView, {
        onShowHelp: () => showHelp("score-card")
      })
    : null,
  "library-quick-view": isBindOauth.value ? h(LibraryQuickView) : null,
