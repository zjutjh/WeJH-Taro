...
import { CAMPUS_OPTION } from "@/constants/electricity";
...
const options = ref(CAMPUS_OPTION.map((item) => item.label));
const selectedOption = computed(() => options.value[selectIndex.value]);
